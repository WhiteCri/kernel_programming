/* **************** CLDD:1.0 s_19/lab1_semaphore.c **************** */
/*
...
mycdrv_read (struct file *file, char __user * buf, size_t lbuf, loff_t * ppos)
{
	...
	printk (KERN_INFO "[%ld] after down_interruptible() my_sem	=%d\n",
		jiffies, my_sem.count);
              ...
              loff_t * ppos)
{
    ...
    printk (KERN_INFO "[%ld] process %i (%s) awakening the readers...\n",
...
MODULE_DESCRIPTION ("CLDD:1.0 s_19/lab1_semaphore.c");
